    ...
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <DashboardClima
          ...
          precipitation={{
            last5Days: [
              { date: "2024-06-01", mm: 2 },
              { date: "2024-06-02", mm: 0 },
              { date: "2024-06-03", mm: 5 },
              { date: "2024-06-04", mm: 1 },
              { date: "2024-06-05", mm: 0 }
            ],
            next5Days: [
              { date: "2024-06-06", mm: 3 },
              { date: "2024-06-07", mm: 0 },
              { date: "2024-06-08", mm: 4 },
              { date: "2024-06-09", mm: 2 },
              { date: "2024-06-10", mm: 1 }
            ]
          }}
          mapData={{
            lat: 4.711,
