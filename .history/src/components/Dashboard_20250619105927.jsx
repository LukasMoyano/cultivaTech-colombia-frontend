  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        (src/components/Dashboardd_2panels/_dashboard_Clima.jsx)
        aqui va el componente que hemos creado apra el dashboard en vez de esta programacion, sino que sea dinamica   
