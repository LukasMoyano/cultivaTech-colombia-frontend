...
import AlertasResumen from "./Dashboardd_2panels/AlertasResumen";
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="flex-1 p-4 min-h-0 overflow-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <DashboardClima />
          // Importa el nuevo componente de resumen de alertas y recomendaciones

          // Resumen de Alertas y Recomendaciones
          <AlertasResumen onVerTodas={() => setCurrentPage("alertas")} />}
          <div className="space-y-4">
            {/* Robot */}
            <div className="card">
              <div className="card-header flex items-center">
