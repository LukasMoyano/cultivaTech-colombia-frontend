...
const OPENWEATHER_API_KEY = "f61630c5193995d939b6b8024057b009";
...
export default function Dashboard_Clima() {
    ...
    useEffect(() => {
        ...
        // One Call API 3.0 (requiere plan adecuado)
        const url = `https://api.openweathermap.org/data/3.0/onecall?lat=${coords.lat}&lon=${coords.lon}&appid=${OPENWEATHER_API_KEY}&units=metric&lang=es&exclude=minutely,alerts`;
            ...
            {loading ? (
                ...
                <>
                    <div className="text-center">
                        ...
                        <p className="cultiva-text-secondary capitalize"></p>
