      ...
      <div className="flex-1 p-4 min-h-0 overflow-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="card"></div>
            <div className="card-header flex items-center">
              <span className="icon-placeholder">⚠️</span> Alertas y Recomendaciones
            </div>
            {/* Componente de alertas y recomendaciones */}
            {/* Este componente debe mostrar un resumen de alertas y recomendaciones actuales */}
            {/* Puedes editar _dashboard_alertasyrecomendaciones.jsx para recibir props si es necesario */}
            {/*
              Ejemplo de uso:
              <DashboardAlertasYRecomendaciones alertas={alertas} recomendaciones={recomendaciones} />
              Por ahora lo importamos y lo mostramos directamente:
            */}
            {/*
              Asegúrate de que el componente exportado en _dashboard_alertasyrecomendaciones.jsx
              se llame DashboardAlertasYRecomendaciones
            */}
            {/* Puedes pasarle props si lo necesitas */}
            {/*
              Ejemplo:
              <DashboardAlertasYRecomendaciones 
                alertas={alertas} 
                recomendaciones={recomendaciones} 
                onVerDetalle={...} 
              />
            */}
            {/* Aquí lo mostramos simple */}
            {React.createElement(require('./Dashboardd_2panels/_dashboard_alertasyrecomendaciones').default)}
          </div>
          <div className="space-y-4">
            {/* Robot */}
            <div className="card">
