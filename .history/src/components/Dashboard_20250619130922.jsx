      ...
      <div className="flex-1 p-4 min-h-0 overflow-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/*
            ...
            Asegúrate de tener la siguiente línea al inicio del archivo:
          */}
          ...
          <div className="card mt-4">
            <div className="card-header flex items-center">
              <span className="icon-placeholder">📊</span> Resumen General
            </div>
            <ul className="list-disc pl-6 py-2 cultiva-text-secondary text-sm">
              <li>Estado general del cultivo: <span className="font-semibold text-green-600">Óptimo</span></li>
              <li>Temperatura promedio: 22°C</li>
              <li>Robot en base, batería al 75%</li>
              <li>Sin alertas críticas activas</li>
              <li>Acceso rápido a 3 cultivos</li>
            </ul>
          </div>}
          <div className="space-y-4">
            {/* Robot */}
